...
public class TileInterface extends JButton{
    ...
    private void setButtonView(){
        ...
        String disabledLocation = "src/ui/flowers/flower" + flowerTypes[controller.getTileNumber() - 1] + "-disabled.png";
        ...
        setDisabledIcon(new ImageIcon(new ImageIcon(disabledLocation).getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
